...
class ProductVIPController extends Controller
{
    ...
    public function vip_night_notify()
    {
        ...
        return $this->notify('??เวรดึก', '00:00:01', '07:59:59', $vip_ward, 'vip_night', '??? งานห้องพิเศษ VIP', 'vip_notifytelegram');
    }

    public function vip_morning_notify()
    {
        $vip_ward = MainSetting::where('name', 'vip_ward')->value('value') ?? '12';
        return $this->notify('??เวรเช้า', '08:00:00', '15:59:59', $vip_ward, 'vip_morning', '??? งานห้องพิเศษ VIP', 'vip_notifytelegram');
    }
    ...
    public function vip_afternoon_notify()
    {
        ...
        return $this->notify('??เวรบ่าย', '16:00:00', '23:59:59', $vip_ward, 'vip_afternoon', '??? งานห้องพิเศษ VIP', 'vip_notifytelegram', $target_date);
    }
