...
class ProductLRController extends Controller
{
    ...
    public function lr_night_notify()
    {
        ...
        return $this->notify('🌙เวรดึก', '00:00:01', '07:59:59', $lr_ward, 'lr_night', '🛏️ งานห้องคลอด LR', 'lr_notifytelegram');
    }

    public function lr_morning_notify()
    {
        $lr_ward = MainSetting::where('name', 'lr_ward')->value('value') ?? '08';
        return $this->notify('เวรเช้า', '08:00:00', '15:59:59', $lr_ward, 'lr_morning', '🛏️ งานห้องคลอด LR', 'lr_notifytelegram');
    }
    ...
    public function lr_afternoon_notify()
    {
        ...
        return $this->notify('เวรบ่าย', '16:00:00', '23:59:59', $lr_ward, 'lr_afternoon', '🛏️ งานห้องคลอด LR', 'lr_notifytelegram', $target_date);
    }
