...
class MainSettingController extends Controller
{
    public function index()
    {
        ...
        $general_settings = $settings->filter(function ($item) {
            return !str_starts_with($item->name, 'er_') &&
                ...
                !str_starts_with($item->name, 'psy_');
        });
        ...
        $psy_settings = $settings->filter(function ($item) {
            return str_starts_with($item->name, 'psy_');
        });
    ...
    public function up_structure(Request $request)
    {
        ...
        $main_setting = [
            ...
            ['name_th' => 'VIP ชม.ผู้ป่วยพักฟื้น(Convalescent)', 'name' => 'vip_patient_type1', 'value' => '0.5'],
            ['name_th' => 'VIP ชม.ผู้ป่วยปานกลาง(Moderate)', 'name' => 'vip_patient_type2', 'value' => '1.16'],
            ['name_th' => 'VIP ชม.ผู้ป่วยกึ่งหนัก(Semi-critical)', 'name' => 'vip_patient_type3', 'value' => '1.83'],
            ['name_th' => 'VIP ชม.ผู้ป่วยหนัก(Critical)', 'name' => 'vip_patient_type4', 'value' => '2.5'],
            ...
            ['name_th' => 'ICU ชม.ผู้ป่วยพักฟื้น(Convalescent)', 'name' => 'icu_patient_type1', 'value' => '0.5'],
            ['name_th' => 'ICU ชม.ผู้ป่วยปานกลาง(Moderate)', 'name' => 'icu_patient_type2', 'value' => '1.16'],
            ['name_th' => 'ICU ชม.ผู้ป่วยกึ่งหนัก(Semi-critical)', 'name' => 'icu_patient_type3', 'value' => '1.83'],
            ['name_th' => 'ICU ชม.ผู้ป่วยหนัก(Critical)', 'name' => 'icu_patient_type4', 'value' => '2.5'],
            ...
            ['name_th' => 'LR ชม.ผู้ป่วยพักฟื้น(Convalescent)', 'name' => 'lr_patient_type1', 'value' => '0.5'],
            ['name_th' => 'LR ชม.ผู้ป่วยปานกลาง(Moderate)', 'name' => 'lr_patient_type2', 'value' => '1.16'],
            ['name_th' => 'LR ชม.ผู้ป่วยกึ่งหนัก(Semi-critical)', 'name' => 'lr_patient_type3', 'value' => '1.83'],
            ['name_th' => 'LR ชม.ผู้ป่วยหนัก(Critical)', 'name' => 'lr_patient_type4', 'value' => '2.5'],
            ...
            ['name_th' => 'สุขภาพจิต รหัสห้องตรวจ (HOSxP)', 'name' => 'psy_department', 'value' => ''],
            ['name_th' => 'สุขภาพจิต ชม.การทำงานพยาบาล', 'name' => 'psy_working_hours', 'value' => '8'],
            ['name_th' => 'สุขภาพจิต ชม.ผู้ป่วยทั่วไป', 'name' => 'psy_patient_type', 'value' => '0.24'],
            ['name_th' => 'สุขภาพจิต NotifyTelegram แจ้งเตือน', 'name' => 'psy_notifytelegram', 'value' => ''],
            ['name_th' => 'สุขภาพจิต NotifyTelegram บันทึก', 'name' => 'psy_notifytelegram_save', 'value' => ''],
            ['name_th' => 'สุขภาพจิต สถานะ', 'name' => 'psy_active', 'value' => 'Y'],
        ];
