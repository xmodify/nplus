    ...
    <div class="container py-5">
        <div class="card-premium mx-auto shadow-lg"
            ...
            <div class="header-gradient text-white text-center py-4">
                ...
                <p class="mb-0 opacity-75">งานสุขภาพจิตและยาเสพติด | เวรเช้า</p>
            </div>
            ...
            <div class="card-body p-4 p-md-5">
                ...
                <form id="psyForm" action="{{ url('product/psy_morning_save') }}" method="POST">
                    @csrf
...
============================ -->
    <script>
        document.getElementById('psyForm').addEventListener('submit', function(e) {
            e.preventDefault();
