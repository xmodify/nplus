                            ...
                            <tr>
                                ...
                                @if ($del_product)
                                    <td class="text-center">
                                        <form action="{{ url('hnplus/product/ari_product_delete/' . $row->id) }}"
                                            method="POST"
...
@push('scripts')
    ...
    <script>
        $(document).ready(function() {
            var table = $('#productivity_ari').DataTable({
                ...
                buttons: [{
                    ...
                    title: 'รายงานผลิตภาพทางการพยาบาล_ARI_{{ $start_date }}_{{ $end_date }}'
                }],
                language: {
                    search: "ค้นหา: ",
