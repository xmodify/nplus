...
@section('content')
            ...
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3">
                <div class="d-flex align-items-center">
                    <div class="bg-soft-primary p-2 rounded-3 me-3">
                        <i class="bi bi-calendar-heart fs-4 text-warning"></i>
                    </div>
                    <div>
                        <h5 class="fw-bold text-dark mb-0">รายงานผลิตภาพทางการพยาบาลแผนกผู้ป่วยนอก (OPD) <span class="badge bg-warning text-dark ms-1">วันหยุด</span></h5>
        ...
        <div class="card-premium shadow-lg">
            <div
                ...
                <h6 class="mb-0 fw-bold">
                    <i class="bi bi-graph-up-arrow me-2"></i>รายงานสรุปผลิตภาพทางการพยาบาล (วันหยุด)
    ...
    <div class="container-fluid mb-5">
        <div class="card-premium shadow-lg">
            <div class="header-gradient text-white p-3">
                <h6 class="mb-0 fw-bold">
                    <i class="bi bi-list-check me-2"></i>การบันทึกข้อมูลผลิตภาพรายเวร (วันหยุด)
                </h6>
            </div>
            <div class="card-body p-4">
                ...
                <div class="table-responsive">
                    <table id="productivity_opd_holiday" class="table table-hover align-middle table-premium">
                            ...
                            <tr>
                                ...
                                @if ($del_product)
                                    <td class="text-center">
                                        <form action="{{ url('product/opd_product_delete/' . $row->id) }}"
                                            method="POST"
    ...
    <div class="container-fluid mb-5">
        <div class="card-premium shadow-lg">
            <div class="header-gradient text-white p-3">
                <h6 class="mb-0 fw-bold">
                    <i class="bi bi-bar-chart-fill me-2"></i>กราฟ Productivity แยกตามเวร (วันหยุด)
                </h6>
            </div>
            <div class="card-body p-4">
                <div style="height: 400px;">
                    <canvas id="productivity_chart_holiday"></canvas>
                </div>
            </div>
        </div>
    </div>
...
@push('scripts')
    ...
    <script>
        $(document).ready(function() {
            var table = $('#productivity_opd_holiday').DataTable({
                ...
                buttons: [{
                    ...
                    title: 'รายงานผลิตภาพทางการพยาบาล_OPD_วันหยุด_{{ $start_date }}_{{ $end_date }}'
                }],
                language: {
                    search: "ค้นหา: ",
        ...
        document.addEventListener("DOMContentLoaded", () => {
            const ctx = document.querySelector('#productivity_chart_holiday');
            if (ctx) {
                new Chart(ctx, {
                    type: 'bar',
                    data: {
                    ...
                    options: {
                        ...
                        plugins: {
                            ...
                            title: {
                                display: true,
                                text: 'กราฟ Productivity แยกตามเวร (วันหยุด)'
                            }
                        },
                        scales: {
                            y: {
