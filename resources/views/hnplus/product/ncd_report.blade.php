        ...
        <div class="card-premium p-3 shadow-sm border-0 bg-white">
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h5 class="fw-bold text-dark mb-0">รายงานผลิตภาพทางการพยาบาลแผนกผู้ป่วย NCD</h5>
    ...
    <div class="container-fluid mb-5">
        <div class="card-premium shadow-lg">
            ...
            <div class="card-body p-4">
                ...
                <div class="table-responsive">
                    <table id="productivity_ncd" class="table table-hover align-middle table-premium">
                        <thead class="bg-soft-blue">
                            <tr>
...
@push('scripts')
    ...
    <script>
        $(document).ready(function() {
            var table = $('#productivity_ncd').DataTable({
                ...
                buttons: [{
                    ...
                    title: 'รายงานผลิตภาพทางการพยาบาล_NCD_{{ $start_date }}_{{ $end_date }}'
                }],
                language: {
                    search: "ค้นหา: ",
