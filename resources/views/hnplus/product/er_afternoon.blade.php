    ...
    <div class="container py-5">
        <div class="card-premium mx-auto shadow-lg"
            ...
            <div class="header-gradient text-white text-center py-4">
                ...
                <p class="mb-0 opacity-75">แผนกอุบัติเหตุ-ฉุกเฉิน (ER) | เวรบ่าย</p>
            </div>
            ...
            <div class="card-body p-4 p-md-5">
                <div class="text-center mb-4">
                    ...
                    <div class="text-secondary small mt-2">
                        <i class="bi bi-clock me-1"></i> ช่วงเวลา 16.00-24.00 น.
                    </div>
                </div>

                <form id="productForm" action="{{ url('product/er_afternoon_save') }}" method="POST">
                    @csrf
