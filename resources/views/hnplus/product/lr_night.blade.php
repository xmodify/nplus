...
<head>
    ...
    <title>บันทึกผลิตภาพทางการพยาบาล LR</title>
    ...
    <div class="container py-5">
        <div class="card-premium mx-auto shadow-lg"
            ...
            <div class="header-gradient text-white text-center py-4">
                <div class="mb-2">
                    <i class="bi bi-person-breastfeeding fs-1"></i>
                </div>
                <h4 class="mb-0 fw-bold">ระบบบันทึกผลิตภาพทางการพยาบาล</h4>
                <p class="mb-0 opacity-75">แผนกห้องคลอด LR | เวรดึก</p>
            </div>
            ...
            <div class="card-body p-4 p-md-5">
                <div class="text-center mb-4">
                    ...
                    <div class="text-secondary small mt-2">
                        <i class="bi bi-moon-stars me-1"></i> ช่วงเวลา 00.00-08.00 น.
                    </div>
                </div>

                <form id="productForm" action="{{ url('hnplus/product/lr_night_save') }}" method="POST">
                    @csrf
                    ...
                    <div class="bg-light rounded-4 p-4 mb-4 border border-white shadow-sm">
                        <h6 class="fw-bold text-dark mb-3 border-bottom pb-2">
                            <i class="bi bi-people-fill me-2 text-primary"></i>รายละเอียดจำนวนผู้ป่วย (LR)
                        </h6>
    ...
    <script>
        document.getElementById('productForm').addEventListener('submit', function(e) {
            ...
            Swal.fire({
                ...
                text: "ตรวจสอบข้อมูลให้ถูกต้องก่อนส่ง (LR)",
                icon: 'question',
