                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <button type="button" class="btn btn-warning btn-sm btn-edit"
                                    ...
                                    data-leave-year-name="{{ $item->LEAVE_YEAR_NAME }}" data-date-begin="{{ $item->DATE_BEGIN }}"
                                    data-date-end="{{ $item->DATE_END }}" data-bs-toggle="modal" data-bs-target="#editModal">
                                    Edit
                                </button>
            ...
            <div class="modal-dialog">
                <form method="POST" action="{{ route('admin.budget_year.store') }}" class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <input class="form-control mb-2" name="LEAVE_YEAR_NAME" type="text"
