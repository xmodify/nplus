                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <button class="btn btn-warning btn-sm btn-edit" data-id="{{ $user->id }}"
                                data-name="{{ $user->name }}" data-email="{{ $user->email }}" data-active="{{ $user->active }}"
                                data-role="{{ $user->role }}" data-bs-toggle="modal" data-bs-target="#editModal">
                                Edit
                            </button>
            ...
            <div class="modal-dialog">
                <form method="POST" id="editForm" class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <br>
                        <input type="checkbox" name="active" id="editActive" value="Y" {{ $user->active === 'Y' ? 'checked' : '' }}>
                        <label for="editActive">เปิดใช้งาน</label>
                        <input class="form-control mb-2" type="password" name="password"
                            placeholder="New Password (ไม่กรอก = ไม่เปลี่ยน)">
                    </div>
