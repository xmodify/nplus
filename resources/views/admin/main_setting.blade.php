        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.querySelectorAll('.manual-run-btn').forEach(btn => {
                btn.addEventListener('click', function() {
                    ...
                    Swal.fire({
                        title: 'ยืนยันรันสคริปต์ส่งงาน?',
                        text: 'ระบบจะส่งแจ้งเตือนของรอบเวลาดังกล่าวไปยัง Telegram',
                        icon: 'question',
                        showCancelButton: true,
                        confirmButtonText: 'รันข้อมูล',
                        cancelButtonText: 'ยกเลิก',
                        ...
                        Swal.fire({
                            ...
                            text: 'กรุณารอสักครู่ ระบบกำลังจัดส่งแจ้งเตือน',
                        ...
                        fetch(`{{ url('admin/main_setting/manual_run') }}/${shift}`, {
                            method: "POST",
                            headers: {
                                "Content-Type": "application/json",
                        ...
                        .catch(err => {
                            Swal.fire({
                                icon: 'error',
                                title: 'ผิดพลาด',
                                text: 'เกิดข้อผิดพลาดในการเชื่อมต่อเซิร์ฟเวอร์: ' + err,
                                confirmButtonText: 'ตกลง'
                            });
                        });
                    });
